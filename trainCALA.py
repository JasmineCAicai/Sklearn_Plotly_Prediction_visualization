...
# FIXME: Read the data
df = pandas.read_csv("CALAAO_pb.csv")
...
GT = df['TotalCALA'].values
NGT = normalization(GT)

print(G2.shape, G3.shape, G4.shape, GT.shape)

# FIXME: 4G Prediction in Caribbean And Latin America
...
# FIXME: Total Prediction in Caribbean And Latin America
...
fig.update_layout(title="Prediction: 4G 5G in Caribbean And Latin America")
